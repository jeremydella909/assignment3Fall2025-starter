            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="contactUpdateController.php?contactID=<?php echo $contacts[$index]->contactID ?>&username=<?php echo $contacts[$index]->username ?>&email=<?php $contacts[$index]->email ?>" role="button">Update</a></td>
                    </tr>
                    <?php
                        }
                    ?>        
